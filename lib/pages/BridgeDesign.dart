...
class BridgeDesign extends StatefulWidget {
  const BridgeDesign({super.key});

  @override
  State<BridgeDesign> createState() => _BridgeDesignState();
}

class _BridgeDesignState extends State<BridgeDesign> {
  @override
